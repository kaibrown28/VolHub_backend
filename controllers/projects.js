...
//     pool.query('INSERT INTO projects (description, projectlead, organization) VALUES($1, $2, $3) RETURNING id', [description, projectlead, organization], (error, results) => {
//       if (error) {
//         throw error
//       }
...
//     pool.query('SELECT * FROM projects WHERE project_id = $1', [id], [id], (error, results) => {
//       if (error) {
//         throw error
//       }
//       response.status(200).json(results.rows)
